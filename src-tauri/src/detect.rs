...
use crate::skill::{
    fixed_skill_roots, namespace_from_host, parse_skill_md, skill_id_from_metadata, FixedSkillRoot,
    Skill, SkillNamespace,
};

/// Legacy: scan all enabled host paths (codex + claude) plus custom paths.
...
fn scan_host_dir(
    ...
    for entry in fs::read_dir(dir)? {
        ...
        skills.push(Skill {
            ...
            namespace: namespace_from_host(host),
            relative_dir: name,
