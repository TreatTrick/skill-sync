...
- [x] **Step 1: Write the failing cross-namespace test**
...
- [x] **Step 3: Implement namespace-scoped collision keys**
...
- [x] **Step 4: Preserve same-namespace rejection**
...
- [x] **Step 1: Update the manifest fetch test to require the exact SHA**
...
- [x] **Step 3: Implement an explicit content ref**
...
- [x] **Step 4: Run GitHub store tests and verify GREEN**
...
- [x] **Step 1: Write journal compatibility and mapping tests**
...
- [x] **Step 2: Run local journal tests and verify RED**
...
- [x] **Step 4: Run local journal tests and verify GREEN**
...
- [x] **Step 1: Write PATCH outcome tests**
...
- [x] **Step 3: Implement the publication outcome contract**
...
- [x] **Step 2: Run each focused test and verify RED**
...
- [x] **Step 3: Expose validated deterministic manifest bytes**
...
- [x] **Step 4: Build complete intended state before commit**
...
- [x] **Step 5: Make every journal transition durable**
...
- [x] **Step 6: Run sync engine tests and verify GREEN**
...
- [x] **Step 1: Write pure reconciliation decision tests**
...
- [x] **Step 2: Run focused command tests and verify RED**
...
- [x] **Step 3: Implement reconciliation under the existing write gate**
...
- [x] **Step 4: Map exact journal evidence to UI recovery info**
...
- [x] **Step 5: Run command and local recovery tests and verify GREEN**
...
- [x] **Step 6: Commit Chunk 3 implementation**
...
- [x] **Step 1: Run Rust formatting and focused regression tests**
...
- [x] **Step 2: Run repository pre-completion checks**
...
- [x] **Step 4: Review final diff and commit verification updates if any**
